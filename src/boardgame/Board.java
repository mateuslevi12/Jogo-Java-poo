...
public class Board {
    ...
    public Board(int rows, int columns) {
        // verifica a condição de existencia do tabuleiro
        if (rows < 1 || columns < 1) {
    ...
    // verifica se a posição ta dentro do tabuleiro 
    // Se a posição existir, retorna a peça (Piece) que está localizada na posição especificada pelas coordenadas row e column no tabuleiro.
    ...
    //Verifica se uma posição específica está dentro do tabuleiro com base nas coordenadas de linha e coluna.
